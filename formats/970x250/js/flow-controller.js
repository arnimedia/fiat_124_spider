       ...
       init:function()
    {
		...
		function car_tires(){
			...
			car_tl
				...
				.set('#tire_front',{css:{transform:'skewX(-2.7deg) scale(.60,.98)'}})
				.set('#tire_back',{css:{transform:'skewX(-2.5deg) scale(.34,.80)'}})
        ...
        // MAIN TIMELINE
				...
				tl.set('#e-key', {rotation: -20, x: -7, y:50, scale:0.8});
				// tl.set('#leasys', {x: 175, y:-5});
				tl.set('#leasys', {x: 14, y:-5});
				tl.set('#base', {x:docWidth, y: 0, scale: 0.5});
				...
				tl.to('#cta-container', 0.5, {y: "-=86", opacity: 1}, label+"+=1");
				// tl.from('#base', 1, {x:"+=970", scale:0.5, onStart: function(){ }}, label+"+=1.5");
				tl.to('#base', 1, {x:394, y:39, scale:1, onStart: function(){ }}, label+"+=1.5");
				...
				tl.to('#cta-container', 0.5, {y: "+=86", delay: 0.7}, label+"+=4");
				...
				tl.to('#pound', 1, {scale: 22}, label+"+=2")
				...
				tl.to('#cta-container', 0.5, {y: "-=86", opacity: 1}, label+"+=1");
				tl.to('#base', 1, {x:394, y:39, scale:1}, label+"+=1.5");
				tl.add(car_tires, label+"+=1.8");
